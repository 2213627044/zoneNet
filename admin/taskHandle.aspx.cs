...
public partial class admin_taskHandle : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                if (m == 1) {iframe1.Visible = false; trExchange.Visible = false;tr1.Visible = true;tr2.Visible = true; };//1：查看，0：编辑
